  ...
  Future<void> _savePortfolio() async {
    ...
    try {
      ...
      for (var image in _newSelectedImages) {
        ...
        final ref = FirebaseStorage.instance.ref().child('portfolio_images/${user.uid}/$fileName');
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Portfolio updated!'), backgroundColor: Colors.green),
        );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save portfolio: $e'), backgroundColor: AppColors.error),
        );
      }
    } finally {
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton.icon(
                    ...
                    icon: const Icon(Icons.add_a_photo, color: AppColors.primaryNavy, size: 18),
                    label: Text('Add', style: AppTextStyles.bodyMedium.copyWith(color: AppColors.primaryNavy, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Icon(Icons.upload_outlined, color: AppColors.textSecondary, size: 40),
