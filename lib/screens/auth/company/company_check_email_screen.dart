...
class CompanyCheckEmailScreen extends StatefulWidget {
  const CompanyCheckEmailScreen({super.key});

  @override
  State<CompanyCheckEmailScreen> createState() =>
      _CompanyCheckEmailScreenState();
}

class _CompanyCheckEmailScreenState extends State<CompanyCheckEmailScreen> {
