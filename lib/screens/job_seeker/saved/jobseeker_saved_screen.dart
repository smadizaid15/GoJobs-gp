      ...
      builder: (context, snapshot) {
        ...
        if (!doc.exists) {
          return _DisabledJobCard(
            title: 'Unavailable',
            message: 'This job posting was removed by the employer.',
            onRemove: () => jobService.toggleSavedJob(userId, jobId),
          );
        }
        ...
        if (!isActive) {
          return _DisabledJobCard(
            title: jobData['title'] ?? 'Closed Job',
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        jobData['salary'] ?? 'Salary unlisted',
                        style: AppTextStyles.bodySmall.copyWith(
                ...
                GestureDetector(
                  onTap: () => jobService.toggleSavedJob(userId, jobId),
                  child: const Icon(
                    Icons.bookmark,
