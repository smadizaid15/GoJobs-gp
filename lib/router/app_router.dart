...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/company/otp',
        builder: (context, state) => const CompanyOtpScreen(),
      ),
      GoRoute(
        path: '/company/forgot-password',
        builder: (context, state) => const CompanyForgotPasswordScreen(),
      ),
      GoRoute(
        path: '/company/check-email',
        builder: (context, state) => const CompanyCheckEmailScreen(),
      ),

      // JobSeeker Auth
      GoRoute(
        path: '/jobseeker/signup',
        builder: (context, state) => const JobseekerSignupScreen(),
      ),
      GoRoute(
        path: '/jobseeker/login',
        builder: (context, state) => const JobseekerLoginScreen(),
      ),
      GoRoute(
        path: '/jobseeker/otp',
        builder: (context, state) => const JobseekerOtpScreen(),
      ),
      GoRoute(
        path: '/jobseeker/forgot-password',
        builder: (context, state) => const JobseekerForgotPasswordScreen(),
      ),
      GoRoute(
        path: '/jobseeker/check-email',
        builder: (context, state) => const JobseekerCheckEmailScreen(),
      ),
      ...
      GoRoute(
        path: '/student/otp',
        builder: (context, state) => const StudentOtpScreen(),
      ),
      GoRoute(
        path: '/student/forgot-password',
        builder: (context, state) => const StudentForgotPasswordScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => const CompanyAddJobScreen(),
      ),
      GoRoute(
        path: '/company/edit-job',
        builder: (context, state) => const CompanyEditJobScreen(),
      ),
      GoRoute(
        path: '/company/job-position-picker',
        builder: (context, state) => const CompanyJobPositionPicker(),
      ),
      GoRoute(
        path: '/company/workplace-type',
        builder: (context, state) => const CompanyWorkplaceTypeSheet(),
      ),
      GoRoute(
        path: '/company/location-picker',
        builder: (context, state) => const CompanyLocationPicker(),
      ),
      GoRoute(
        path: '/company/job-type',
        builder: (context, state) => const CompanyJobTypeSheet(),
      ),
      GoRoute(
        path: '/company/applicants',
        builder: (context, state) => const CompanyApplicantsScreen(),
      ),
      GoRoute(
        path: '/company/messages',
        builder: (context, state) => const CompanyMessagesScreen(),
      ),
      GoRoute(
        path: '/company/notifications',
        builder: (context, state) => const CompanyNotificationsScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => const CompanyUpdatePasswordScreen(),
      ),
      GoRoute(
        path: '/company/chat',
      ...
      GoRoute(
        path: '/jobseeker/filter',
        builder: (context, state) => const JobseekerFilterScreen(),
      ),
      GoRoute(
        path: '/jobseeker/saved',
        builder: (context, state) => const JobseekerSavedScreen(),
      ),
      GoRoute(
        path: '/jobseeker/messages',
        builder: (context, state) => const JobseekerMessagesScreen(),
      ),
      GoRoute(
        path: '/jobseeker/chat',
        builder: (context, state) => const JobseekerChatScreen(),
      ),
      GoRoute(
        path: '/jobseeker/notifications',
        builder: (context, state) => const JobseekerNotificationsScreen(),
      ),
      GoRoute(
        path: '/jobseeker/settings',
        builder: (context, state) => const JobseekerSettingsScreen(),
      ),
      GoRoute(
        path: '/jobseeker/update-password',
        builder: (context, state) => const JobseekerUpdatePasswordScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => const JobseekerEditProfileScreen(),
      ),
      GoRoute(
        path: '/jobseeker/work-experience',
        builder: (context, state) => const JobseekerWorkExperienceScreen(),
      ),
      GoRoute(
        path: '/jobseeker/education',
        builder: (context, state) => const JobseekerEducationScreen(),
      ),
      GoRoute(
        path: '/jobseeker/skills',
        builder: (context, state) => const JobseekerSkillsScreen(),
      ),
      GoRoute(
        path: '/jobseeker/language',
        builder: (context, state) => const JobseekerLanguageScreen(),
      ),
      GoRoute(
        path: '/jobseeker/about-me',
        builder: (context, state) => const JobseekerAboutMeScreen(),
      ),
      GoRoute(
        path: '/jobseeker/resume',
        builder: (context, state) => const JobseekerResumeScreen(),
      ),
      GoRoute(
        path: '/jobseeker/service-providers',
        builder: (context, state) => const JobseekerServiceProvidersScreen(),
      ),
      GoRoute(
        path: '/jobseeker/chat-from-providers',
        builder: (context, state) => const JobseekerChatScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: '/freelancer/about-me',
        builder: (context, state) => const FreelancerAboutMeScreen(),
      ),
      GoRoute(
        path: '/freelancer/services',
        builder: (context, state) => const FreelancerServicesScreen(),
      ),
      GoRoute(
        path: '/freelancer/expertise',
        builder: (context, state) => const FreelancerExpertiseScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => const FreelancerMessagesScreen(),
      ),
      GoRoute(
        path: '/freelancer/notifications',
        builder: (context, state) => const FreelancerNotificationsScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => const StudentUpdatePasswordScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: '/student/saved',
        builder: (context, state) => const StudentSavedScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => const StudentCourseDetailScreen(),
      ),
      GoRoute(
        path: '/student/internship-categories',
      ...
      GoRoute(
        ...
        builder: (context, state) => const StudentApplicationSuccessScreen(),
      ),
      GoRoute(
        path: '/student/service-providers',
        builder: (context, state) => const StudentServiceProvidersScreen(),
      ),
      GoRoute(
        path: '/student/chat-from-providers',
      ...
      GoRoute(
        ...
        builder: (context, state) => const AIJobDescriptionScreen(),
      ),
      GoRoute(
        path: '/ai-job-match',
        builder: (context, state) {
